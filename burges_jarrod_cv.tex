...
\reverselabel{3}
  ...
  \item Metcalf, K. and \textbf{Burges, J.} (2026). GeoCORK: An improved workflow for U-Pb geochronology data management. \textit {In review Applied Computing and Geosciences}
\end{enumerate}
