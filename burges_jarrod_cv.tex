...
\setlength{\itemindent}{-.19in}
  \item \textbf{Burges, J.M.}, Yakymchuk, C., DiMaio, M., Lui, C.C., and Morrison, S.M. (2026). Metamorphic or igneous zircon? Classification through rare earth elements, machine learning, and logistic regression (Submitted)
  \item Metcalf, K. and \textbf{Burges, J.} (2026). GeoCORK: An improved workflow for U-Pb geochronology data management. (In review)
\end{enumerate}
