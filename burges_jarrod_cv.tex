...
My primary research interests involve exploring the applications of developing machine learning models to answer complex multivariate problems within the geological and planetary science disciplines. In addition, interests lie with research data management tool/application workflows to conduct more efficient data. management for researchers.
...
\setlength{\itemindent}{-.19in}
  \item Metcalf, K. and \textbf{Burges, J.} (2025). GeoCORK: An improved workflow for geochronology data management. (In review)
\end{enumerate}
