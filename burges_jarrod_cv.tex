...
% Optional: redefine family defaults so everything uses the mono font
...
\reverselabel{1}%
\setlength{\itemindent}{-.25in}
  \item Metcalf, K. and \textbf{Burges, J.} (2024). GeoCORK: An improved workflow for geochronology data management. (In review)
\end{enumerate}
